...
class CrudRepository:
    ...
    # ToDo: return object instead of dictionary
    ...
    def read_all(self, sort_field: str = "_id", query: Dict[str, Any] = {}) -> List[Dict[str, Any]]:
        """
        ...
        """
        return list(self.collection.find(query).sort(sort_field, ASCENDING))

    def update(self, _id: str, document: Any) -> bool:
        """
